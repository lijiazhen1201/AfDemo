...
public class ImageSelectorActivity extends AppCompatActivity {
     ...
     */
    public static void openActivity(Activity activity, int requestCode, boolean isSingle, int maxSelectCount) {
     ...
     * @param maxSelectCount 图片的最大选择数量，小于等于0时，不限数量，isSingle为false时才有用。
     */
    public static void openActivity(Activity activity, int requestCode, boolean isSingle, int maxSelectCount, boolean isCamera) {
