package cn.appoa.qrcodescan.coding;
...
public class ZmZxUtils {
    ...
    /**
     * logo大小默认为二维码整体大小的1/5
     */
    private static int logoSize = 5;
    ...
    private static Bitmap addLogo(Bitmap src, Bitmap logo) {
        ...
        // logo大小
        float scaleFactor = srcWidth * 1.0f / logoSize / logoWidth;
