...
/**
 * ===================================== 作 者: 陈嘉桐 版 本：1.0.4 创建日期：2017/4/25 描 述：
 * =====================================
 */
public class JCameraView extends FrameLayout implements CameraInterface.CamOpenOverCallback, SurfaceHolder.Callback {
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSize = a.getDimensionPixelSize(R.styleable.JCameraView_iconSize,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 36, getResources().getDisplayMetrics()));
        iconMargin = a.getDimensionPixelSize(R.styleable.JCameraView_iconMargin,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.ic_camera_enhance_black_24dp);
    ...
    private void initView() {
        ...
        LayoutParams photoParam = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureLisenter() {
            ...
            public void recordShort(long time) {
                ...
                stopping = true;
                mCaptureLayout
                        .setTextWithAnimation(getContext().getResources().getString(R.string.recording_too_short));
            ...
            public void recordStart() {
                ...
                CameraInterface.getInstance().startRecord(mVideoView.getHolder().getSurface(),
                        new CameraInterface.ErrorCallback() {
                            @Override
                            public void onError() {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (event.getPointerCount() == 2) {
                    ...
                    float result = (float) Math
                            .sqrt(Math.pow(point_1_X - point_2_X, 2) + Math.pow(point_1_Y - point_2_Y, 2));
