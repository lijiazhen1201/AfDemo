...
//    }
    ...
    public static void setRequestedOrientation(Context context, int orientation) {
        if (JZUtils.getFragmentActivity(context) != null) {
            JZUtils.getFragmentActivity(context).setRequestedOrientation(
                    orientation);
        } else {
            JZUtils.scanForActivity(context).setRequestedOrientation(
                    orientation);
    ...
    public static Window getWindow(Context context) {
        if (JZUtils.getFragmentActivity(context) != null) {
            return JZUtils.getFragmentActivity(context).getWindow();
        } else {
            return JZUtils.scanForActivity(context).getWindow();
        }
    }
