...
public abstract class PullToRefreshBaseFragment<V extends View> extends AfFragment<PullToRefreshPresenter>
    ...
    private void setRefreshLayout() {
        ...
        // refreshLayout.setOnMultiPurposeListener(new
        // SimpleMultiPurposeListener());//设置多功能监听器
        // refreshLayout.setScrollBoundaryDecider(new
        // ScrollBoundaryDecider());//设置滚动边界判断
