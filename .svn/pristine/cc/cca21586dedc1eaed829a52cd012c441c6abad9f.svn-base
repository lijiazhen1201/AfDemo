 ...
 * 自定义下拉刷新布局
 */
public class RefreshHandLayout extends FrameLayout implements RefreshHeader {

    public RefreshHandLayout(Context context) {
        this(context, null);
    }

    public RefreshHandLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RefreshHandLayout(Context context, AttributeSet attrs, int defStyleAttr) {
